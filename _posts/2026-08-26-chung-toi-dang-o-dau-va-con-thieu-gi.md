...
Bản ký số/notarize cho bản desktop — bước cần để hệ điều hành không cảnh báo "ứng dụng không rõ nguồn gốc" khi mở lần đầu — chưa hoàn tất. Smoke test cho bản web hosted cũng chưa chạy. Bản iOS mới ở mức khung sườn (scaffold), chưa có gì để dùng thử.
